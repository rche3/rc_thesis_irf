function [Sim_Data, trueirf] = sim_data_VAR(y,maxh,long_auto,burnin,M,badj) 
...
%Output:
    %Sim_Data is the qxTxM matrix of simulated data
...
Sim_Data=zeros(q,T+burnin,M);

CholSigma=chol(Sigma_hold,'lower');
    
   for m=1:M
for t = arp+1:T+burnin 
