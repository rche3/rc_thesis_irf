function [CoverageVAR_analytictemp, LengthVAR_analytictemp, BiasVAR_analytictemp] = var_analytical_infinite_summary(y,arp,maxh,trueirf,confint) 

%Calculates coverage, length, and bias in Monte Carlos for infinite order VAR following Lutkepohl (1990) Prop 1
%and Lutkepohl 2005 prop 15.4. Doesn't calculate summary statistics in long run restriction case.
