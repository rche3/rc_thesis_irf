...
filename = "Bootstrap/results/newweightsT300s_rind2_rzDGPVAR2_SVARLP_MC" + num2str(n_MC) + "_BS" + num2str(n_straps) + ".mat";
...
res = load("Bootstrap/results/rind2_rzDGPVAR2_SVARLP_MC500_BS200.mat");
...
saveas(fig, 'Fig/newweightsT300s_rzdgp_rind2_MC_test_mdlavg_strap.png')
