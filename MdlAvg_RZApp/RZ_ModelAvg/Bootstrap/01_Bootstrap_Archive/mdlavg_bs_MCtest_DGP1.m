...
filename = "Bootstrap/results/VAR1_lp_MC" + num2str(n_MC) + "_BS" + num2str(n_straps) + ".mat";
...
for i = 1:n_MC
    ...
    [liny, confidencey] = linSVAR(y,H,nlag,rind,sind,clevel,use_bootstrap,n_straps,normalise);
...
filename = "Bootstrap/results/VAR1_SVAR_MC" + num2str(n_MC) + "_BS" + num2str(n_straps) + ".mat";
...
filename = "Bootstrap/results/VAR1_SVARLP_MC" + num2str(n_MC) + "_BS" + num2str(n_straps) + ".mat";
...
res = load("Bootstrap/results/VAR1_SVARLP_MC1000_BS500.mat");
...
saveas(fig, 'Fig/MC_test_mdlavg_strap.png')
