...
parfor i_MC = 1:settings.simul.n_MC
    disp(['Completed ', num2str(settings.simul.n_MC - i_MC), ' out of ', num2str(settings.simul.n_MC)])
    ...
    for i_spec = 1:settings.specifications.n_spec
        ...
        for i_method = 1:settings.est.n_methods         
            ...
            switch settings.est.methods_name{i_method}
                ...
                %%% BELOW REQUIRE IV spec to estimate
...
clear save_folder save_pre save_mode_dir save_suff mode_list
