...
settings.simul.n_MC    = 2; % number of Monte Carlo reps
...
settings.est.methods_name    = {'svar','svar_corrbias','bvar','lp','lp_corrbias','lp_penalize','var_avg', 'lp_lagaug', 'lp_gls', 'resid_est'};
