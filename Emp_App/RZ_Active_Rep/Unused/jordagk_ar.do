...
local tax = 1; /*0 = exclude taxes, 1 = include taxes */
...
list h multlin1 seylin arcib arcit multexp1 seyexp arexpcib arexpcit multrec1 seyrec arreccib arreccit if h<=20;
outsheet h multlin1 seylin arcib arcit multexp1 seyexp arexpcib arexpcit multrec1 seyrec arreccib arreccit using junkmultsear.csv if h<=20, comma replace ;
...
list h multlin1 multexp1 multrec1 ptestdiff arp if h<=20;
outsheet h multlin1 multexp1 multrec1 arp using junkarp.csv if h<=20, comma replace;
