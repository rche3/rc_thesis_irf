function [stateay, stateby, confidenceya, confidenceyb, bs_betadista, bs_betadistb, pvala, pvalb] = statelp_rc(data, ...
    x,hor,rpost,transformation, clevel, opt, bootstrap, emp, nlag, nstraps) 
% edited version of Ramey and Zubairy (2018) state dependent local
